...
function loadData_to_new(fileurl) {
    ...
    // xmlhttp.withCredentials = true; // 设置带有 Cookie 的资源请求
    // xmlhttp.open("GET", 'http://www.douhuayolo.com:8080/zdzh/appmessage/getAppMessageByHot.do?USERID=100198&currentPage=1&showCount=10&XINDEX=31.31369&YINDEX=121.522007&LASTTIME=2016-10-12%2018:42:12&REGISTID=2016101217265221770&LOCALPAGE=0&FKEY=cdaa2fd7c01183ad57c0e4755d0cd77f');
    // xmlhttp.send();
